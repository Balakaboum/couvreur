...
export default function Footer(){
  return (
    <footer className="bg-[#06182A] pb-24 pt-16 text-blue-100 md:pb-10">
      <div className="site-wrap grid gap-10 divide-y divide-white/10 text-center md:grid-cols-2 md:divide-y-0 md:text-left lg:grid-cols-3">
        <div>
        ...
        <div className="pt-10 md:pt-0">
          ...
          <div className="mt-4 grid gap-3 text-sm">
            <a href="tel:+33658919511">06 58 91 95 11</a>
